...
function App() {
  ...
  const magic = new Magic('pk_live_6DEECDD2F9A77399', {
      ...
      <Router>
        ...
        <div className="main-content">
          <Routes>
            ...
            <Route exact path="/live-stream" element={<LiveStreams contract={contract} account={account} />} />
            <Route exact path="/create-stream" element={<CreateStream contract={contract} account={account} />} />
            <Route exact path="/schedule-stream" element={<ScheduledStreams contract={contract} account={account} />} />
            <Route exact path="/streams" element={<AllStreams contract={contract} account={account} />} />
            <Route exact path="/all-artists" element={<AllArtists contract={contract} account={account} />} />
            <Route exact path="/all-nfts" element={<AllNfts contract={contract} account={account} />} />
            <Route exact path="/stream-play" element={<StreamPlay />} />
            <Route exact path="/make-schedule" element={<MakeSchedule contract={contract} account={account} />} />
            <Route exact path="/user/" element={<SingleUser contract={contract} account={account} />} />
            <Route exact path="/profile" element={<Profile contract={contract} account={account} />} />
